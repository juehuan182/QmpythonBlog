...
LOGGING = {
    'version': 1,
    'disable_existing_loggers': False,  # 是否禁用已经存在的日志器, False表示不禁用
    # 日志信息显示的格式
    'formatters': {
        # 详细的日志格式
        'standard': {
    ...
    'loggers': {
        'qmpython': {
            'handlers': ['console', 'file'],  # 可以同时向终端与文件中输出日志，上线之后可以把'console'移除
...
# 参考：https://blog.csdn.net/Odyssues_lee/article/details/80891456
